...
namespace dggt
{
	...
	struct mat<3,3,T>
	{
		...
		/*!
		 * @brief The (0,2)'nd element, columns written first.
		 * */
		T m02;
		...
		/*!
		 * @brief The (1,2)'nd element, columns written first.
		 * */
		T m12;

		/*!
		 * @brief The (2,0)'th element, columns written first.
		 * */
		T m20;

		/*!
		 * @brief The (2,1)'th element, columns written first.
		 * */
		T m21;

		/*!
		 * @brief The (2,2)'nd element, columns written first.
		 * */
		T m22;
		 ...
		 *
		 * Each element in the main diagonal is set to T(1) (ie. the 3x3
		 * identity matrix.).
		 * */
		mat();

		/*!
		 * @brief A constructor taking an array of 9 elements to be copied
		 * column-major-wise.
		 ...
		 * @return A 3-by-3 matrix with which is the transpose of original matrix.
		 * */
		mat transpose() const;
		 ...
		 * mat*mat.inverse()=mat.inverse*mat=MAT3_IDENTITY<T>.  If the
		 ...
		 * @param An unsigned integer representing the desired column ranging from 0 to 2.
		 * @param An unsigned integer representing he desired row from ranging from 0 to 2. 
		 ...
		 * @param index A u32 representing the desired column ranging from 0 to 2.
		 ...
		 * @param index A u32 representing the desired row ranging from 0 to 2.
		...
		/*!
		 * @brief Sets a column.
		 * @param column A u32 representing the column to set ranging from 0 to 2.
		...
		/*!
		 * @brief Sets a row.
		 * @param row A u32 representing the row to set ranging from 0 to 2.
		 * @param val A const reference to a vector of type vec<3,T> representing the desired row to set.
		 * @return A reference to the newly transformed matrix.
		 * */
...
namespace dggt
{
	...
	/*!
	 * @brief A short way to write mat<3,3,T>
	 * */
	template <typename T>
	using mat3=mat<3,3,T>;

	/*!
	 * @brief A short way to write mat<3,3,real32>.
	 * */
